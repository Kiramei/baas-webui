...
export const Modal: React.FC<ModalProps> = (
    {isOpen, onClose, title, children, titleNode = undefined, width = 40}
) => {
    useEffect(() => {
        ...
        <div className={overlayCls} onMouseDown={(e) => {
            ...
            >
                <div className='overflow-auto px-2' style={{maxHeight: 'calc(100vh - 80px)'}}>
                    <div
                        className="flex items-center justify-between p-0 border-b border-slate-200 dark:border-slate-700">
                        {
                            titleNode ? titleNode :
